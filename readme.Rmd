...
We are currently finialising the package for inclusion in the next Bioconductor release.  Please contact helen (dot) lindsay (at) uzh (dot) ch for more information. 
