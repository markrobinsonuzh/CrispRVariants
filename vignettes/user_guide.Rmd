...
reference=reverseComplement(DNAString(reference))
...
txdb <- makeTxDbFromGFF("Danio_rerio.GRCz10.81_chr17.gtf", format = "gtf")
...
library(GenomicFeatures)
txdb_fname <- system.file("extdata/GRCz10_81_ptena_txdb.sqlite", package="crispRvariants")
